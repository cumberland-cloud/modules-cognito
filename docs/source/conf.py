...
html_theme_options = {
    ...
    'base_url': 'https://cumberland-cloud.github.io/modules-cognito/',
    ...
    'repo_url': 'https://github.com/cumberland-cloud/modules-cognito',
    'repo_name': 'modules-cognito',
